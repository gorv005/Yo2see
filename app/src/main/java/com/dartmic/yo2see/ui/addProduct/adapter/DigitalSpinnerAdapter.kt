...
class DigitalSpinnerAdapter(ctx: Activity, countries: ArrayList<GeneralListItem>, var list: ArrayList<Boolean>) :
    ArrayAdapter<GeneralListItem>(ctx, 0, countries) {
 ...
 //   private var updatePos=0
    ...
    private fun createItemView(position: Int, recycledView: View?, parent: ViewGroup): View {
        val value = getItem(position)?.genValue
