...
import kotlinx.android.synthetic.main.item_event_product.view.*


class AdapterEventProductList(
...
) : ListAdapter<ListingItemEvent, AdapterEventProductList.ViewHolder>(
    AdapterEventProductListCallback()
) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        p1: Int
    ): AdapterEventProductList.ViewHolder {
        val itemView = LayoutInflater.from(
            parent.context
        ).inflate(R.layout.item_event_product, parent, false)
